...
$("#navParty").click(function() {
			$('html, body').animate({
			scrollTop: $("#cocktailParty").offset().top
			}, 1000);
});
$("#navCompetetors").click(function() {
			$('html, body').animate({
...
$("#vtButton").click(function() {
	Materialize.Toast.removeAll();
	Materialize.toast('Coming Soon', 1000, 'rounded');
	setTimeout(function() {Materialize.toast('Ready For the Party?', 1500, 'rounded');}, 1100);

});

$("#Gallery").click(function() {
	Materialize.Toast.removeAll();
	Materialize.toast('All photos will be shared after the party', 1000, 'rounded');
	setTimeout(function() {Materialize.toast('Ready For the Party?', 1500, 'rounded');}, 1100);
